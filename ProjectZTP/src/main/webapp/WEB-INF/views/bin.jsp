            ...
            <div class="header">
                ...
                <div class="content">
                    ...
                    <table border='1'>
                        ...
                        <c:forEach var="product" items="${binForm.productList}">
                            <tr> 
                                <td>${product.id}</td>
                                <td>${product.name}</td>
                                <td>${product.price}</td>
                    ...
                    <table border='1'>
                        ...
                        <c:forEach var="product" items="${binForm.extraList}">
                            <tr> 
                                <td>${product.id}</td>
                                <td>${product.name}</td>
                                <td>${product.price}</td>
                    ...
                    <form:form action="/ProjectZTP/editPurchaseBin" method="POST" modelAttribute="binForm">
                        ...
                        Extra: <form:radiobutton path="extraName" value="Chocolate" checked="checked" /> czekolada<form:radiobutton path="extraName" value="Powdered sugar" checked="checked" /> cukier puder<form:radiobutton path="extraName" value="" checked="checked" /> brak<br><br>
